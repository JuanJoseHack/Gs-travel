...
import 'package:GsTravel/src/presentation/pages/client/payment/installments/ClientPaymentInstallmentsContent.dart';
import 'package:GsTravel/src/presentation/pages/client/payment/installments/bloc/ClientPaymentInstallmentsBloc.dart';
import 'package:GsTravel/src/presentation/pages/client/payment/installments/bloc/ClientPaymentInstallmentsEvent.dart';
import 'package:GsTravel/src/presentation/pages/client/payment/installments/bloc/ClientPaymentInstallmentsState.dart';
...
class _ClientPaymentInstallmentsPageState
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: BlocListener<ClientPaymentInstallmentsBloc,
        ...
        child: BlocBuilder<ClientPaymentInstallmentsBloc,
            ClientPaymentInstallmentsState>(
          builder: (context, state) {
            ...
            if (responseState is Loading) {
              ...
              return ClientPaymentInstallmentsContent(
